...
} from "@/components/data-table-2/faceted-filter"
import {
  Sortable,
  SortableDragHandle,
  SortableItem,
} from "@/components/data-table-2/sortable"
    ...
    <Sortable
      ...
      overlay={
        <div className="flex items-center gap-2">
          ...
          <div className="h-8 w-32 rounded-sm bg-primary/10" />
          <div className="min-w-36 h-8 flex-1 rounded-sm bg-primary/10" />
    ...
    >
      <Popover>
        ...
        <PopoverContent
          ...
          collisionPadding={16}
          className={cn(
            "min-w-60 flex w-[calc(100vw-theme(spacing.12))] origin-[var(--radix-popover-content-transform-origin)] flex-col p-4 sm:w-[36rem]",
