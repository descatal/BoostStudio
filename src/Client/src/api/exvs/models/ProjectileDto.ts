...
/**
 * Check if a given object implements the ProjectileDto interface.
 */
export function instanceOfProjectileDto(value: object): value is ProjectileDto {
    return true;
}

export function ProjectileDtoFromJSON(json: any): ProjectileDto {
    return ProjectileDtoFromJSONTyped(json, false);
}

export function ProjectileDtoFromJSONTyped(json: any, ignoreDiscriminator: boolean): ProjectileDto {
    if (json == null) {
        return json;
    }
    return {
...
export function ProjectileDtoToJSON(value?: ProjectileDto | null): any {
    if (value == null) {
        return value;
    }
    return {
