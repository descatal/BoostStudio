...
export const zPackFhmAssetCommand = z.object({
    assetFileHashes: z.union([
        z.null(),
        z.array(z.number().int())
    ]).optional(),
    assetFileTypes: z.union([
        z.null(),
...
export const zPackPsarcByPathCommand = z.object({
    ...
    compressionLevel: z.union([
        z.null(),
        z.number().int().default(9)
    ]).optional().default(9)
});
...
export const zPlayableCharacterDto = z.object({
    ...
    unk124: z.number().int().optional(),
    unk128: z.number().int().optional(),
    catalogStorePilotCostume2TString: z.union([
        z.null(),
        z.string()
    ]).optional(),
    catalogStorePilotCostume2String: z.union([
        z.null(),
        z.string()
    ]).optional(),
    catalogStorePilotCostume3TString: z.union([
        z.null(),
        z.string()
    ]).optional(),
    catalogStorePilotCostume3String: z.union([
        z.null(),
        z.string()
    ]).optional(),
    ...
    inGameSortieAndAwakeningPilotCostume1SpriteAssetHash: z.number().int().optional(),
    inGameSortieAndAwakeningPilotCostume2SpriteAssetHash: z.number().int().optional(),
    inGameSortieAndAwakeningPilotCostume3SpriteAssetHash: z.number().int().optional(),
