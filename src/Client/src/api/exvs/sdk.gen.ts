...
import type { GetApiAmmoData, GetApiAmmoResponse, PostApiAmmoData, DeleteApiAmmoByHashData, GetApiAmmoByHashData, GetApiAmmoByHashResponse, PostApiAmmoByHashData, PostApiAmmoImportData, PostApiAmmoExportData, PostApiAmmoExportPathData, GetApiConfigsData, GetApiConfigsResponse, PostApiConfigsData, DeleteApiConfigsByKeyData, GetApiConfigsByKeyData, GetApiConfigsByKeyResponse, PostApiDebugData, GetApiFhmPackPathData, GetApiFhmUnpackPathData, PostApiFhmPackData, PostApiFhmPackResponse, PostApiFhmUnpackData, PostApiFhmUnpackResponse, PostApiFhmPackAssetData, PostApiFhmUnpackAssetData, PostApiPsarcPackPathData, PostApiPsarcUnpackPathData, PostApiPsarcPackPatchFilesData, PostApiPsarcUnpackPatchFilesData, GetApiScexDecompiledByUnitIdData, GetApiScexDecompiledByUnitIdResponse, PostApiScexCompilePathData, PostApiScexDecompilePathData, PostApiScexHotReloadPathData, PostApiScexCompileUnitsData, PostApiScexDecompileUnitsData, GetApiUnitsData, GetApiUnitsResponse, PostApiUnitsData, GetApiUnitsByUnitIdData, GetApiUnitsByUnitIdResponse, PostApiUnitsByUnitIdData, GetApiUnitsByUnitIdPlayableCharactersData, GetApiUnitsByUnitIdPlayableCharactersResponse, PostApiUnitsByUnitIdPlayableCharactersData, PostApiUnitsBulkData, PostApiUnitsPlayableCharactersImportData, PostApiUnitsPlayableCharactersExportData, GetApiPatchFilesData, GetApiPatchFilesResponse, PostApiPatchFilesData, GetApiPatchFilesSummaryData, GetApiPatchFilesSummaryResponse, DeleteApiPatchFilesByIdData, GetApiPatchFilesByIdData, GetApiPatchFilesByIdResponse, PostApiPatchFilesByIdData, PostApiPatchFilesResizeData, GetApiTblDeserializePathData, GetApiTblDeserializePathResponse, PostApiTblDeserializeData, PostApiTblDeserializeResponse, GetApiTblSerializePathData, PostApiTblSerializeData, GetApiTblByIdData, GetApiTblByIdResponse, PostApiTblImportData, PostApiTblExportData, GetApiStatsData, GetApiStatsResponse, PostApiStatsData, DeleteApiStatsByIdData, GetApiStatsByIdData, GetApiStatsByIdResponse, PostApiStatsByIdData, GetApiUnitStatsData, GetApiUnitStatsResponse, GetApiUnitStatsByUnitIdData, GetApiUnitStatsByUnitIdResponse, PostApiUnitStatsImportData, PostApiUnitStatsExportData, PostApiUnitStatsExportPathData, GetApiUnitStatsAmmoSlotByUnitIdData, GetApiUnitStatsAmmoSlotByUnitIdResponse, PostApiUnitStatsAmmoSlotData, PostApiUnitStatsAmmoSlotResponse, DeleteApiUnitStatsAmmoSlotByIdData, PostApiUnitStatsAmmoSlotByIdData, GetApiSeriesData, GetApiSeriesResponse, PostApiSeriesData, GetApiSeriesUnitsData, GetApiSeriesUnitsResponse, PostApiSeriesImportData, PostApiSeriesExportData, GetApiProjectilesData, GetApiProjectilesResponse, PostApiProjectilesData, DeleteApiProjectilesByHashData, GetApiProjectilesByHashData, GetApiProjectilesByHashResponse, PostApiProjectilesByHashData, GetApiUnitProjectilesData, GetApiUnitProjectilesResponse, GetApiUnitProjectilesByUnitIdData, GetApiUnitProjectilesByUnitIdResponse, PostApiUnitProjectilesImportData, PostApiUnitProjectilesImportPathData, PostApiUnitProjectilesExportData, PostApiUnitProjectilesExportPathData, GetApiHitboxesData, GetApiHitboxesResponse, PostApiHitboxesData, DeleteApiHitboxesByHashData, GetApiHitboxesByHashData, GetApiHitboxesByHashResponse, PostApiHitboxesByHashData, GetApiHitboxGroupsData, GetApiHitboxGroupsResponse, PostApiHitboxGroupsData, GetApiHitboxGroupsHashByHashData, GetApiHitboxGroupsHashByHashResponse, GetApiHitboxGroupsUnitIdByUnitIdData, GetApiHitboxGroupsUnitIdByUnitIdResponse, PostApiHitboxGroupsByHashData, PostApiHitboxGroupsImportData, PostApiHitboxGroupsImportPathData, PostApiHitboxGroupsExportData, PostApiHitboxGroupsExportPathData, GetApiAssetsData, GetApiAssetsResponse, PostApiAssetsData, DeleteApiAssetsByHashData, GetApiAssetsByHashData, GetApiAssetsByHashResponse, PostApiAssetsByHashData, PostApiAssetsImportData } from './types.gen';
...
export const getApiAmmo = <ThrowOnError extends boolean = false>(options?: Options<GetApiAmmoData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).get<GetApiAmmoResponse, unknown, ThrowOnError>({
        url: '/api/ammo',
        ...options
    });
};
...
export const getApiAmmoByHash = <ThrowOnError extends boolean = false>(options: Options<GetApiAmmoByHashData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<GetApiAmmoByHashResponse, unknown, ThrowOnError>({
        url: '/api/ammo/{hash}',
        ...options
    });
};
...
export const getApiConfigs = <ThrowOnError extends boolean = false>(options: Options<GetApiConfigsData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<GetApiConfigsResponse, unknown, ThrowOnError>({
        url: '/api/configs',
        ...options
    });
};
...
export const getApiConfigsByKey = <ThrowOnError extends boolean = false>(options: Options<GetApiConfigsByKeyData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<GetApiConfigsByKeyResponse, unknown, ThrowOnError>({
        url: '/api/configs/{key}',
        ...options
    });
};
...
export const postApiFhmPack = <ThrowOnError extends boolean = false>(options: Options<PostApiFhmPackData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<PostApiFhmPackResponse, unknown, ThrowOnError>({
        ...formDataBodySerializer,
        url: '/api/fhm/pack',
        ...options,
        headers: {
...
export const postApiFhmUnpack = <ThrowOnError extends boolean = false>(options: Options<PostApiFhmUnpackData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<PostApiFhmUnpackResponse, unknown, ThrowOnError>({
        ...formDataBodySerializer,
        url: '/api/fhm/unpack',
        ...options,
        headers: {
...
export const getApiScexDecompiledByUnitId = <ThrowOnError extends boolean = false>(options: Options<GetApiScexDecompiledByUnitIdData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<GetApiScexDecompiledByUnitIdResponse, unknown, ThrowOnError>({
...
export const getApiUnits = <ThrowOnError extends boolean = false>(options?: Options<GetApiUnitsData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).get<GetApiUnitsResponse, unknown, ThrowOnError>({
        url: '/api/units',
        ...options
    });
};
...
export const getApiUnitsByUnitId = <ThrowOnError extends boolean = false>(options: Options<GetApiUnitsByUnitIdData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<GetApiUnitsByUnitIdResponse, unknown, ThrowOnError>({
...
export const getApiUnitsByUnitIdPlayableCharacters = <ThrowOnError extends boolean = false>(options: Options<GetApiUnitsByUnitIdPlayableCharactersData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<GetApiUnitsByUnitIdPlayableCharactersResponse, unknown, ThrowOnError>({
...
export const getApiPatchFiles = <ThrowOnError extends boolean = false>(options?: Options<GetApiPatchFilesData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).get<GetApiPatchFilesResponse, unknown, ThrowOnError>({
        url: '/api/patch-files',
        ...options
    });
};
...
export const getApiPatchFilesSummary = <ThrowOnError extends boolean = false>(options?: Options<GetApiPatchFilesSummaryData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).get<GetApiPatchFilesSummaryResponse, unknown, ThrowOnError>({
...
export const getApiPatchFilesById = <ThrowOnError extends boolean = false>(options: Options<GetApiPatchFilesByIdData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<GetApiPatchFilesByIdResponse, unknown, ThrowOnError>({
        url: '/api/patch-files/{id}',
        ...options
    });
};
...
export const getApiTblDeserializePath = <ThrowOnError extends boolean = false>(options: Options<GetApiTblDeserializePathData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<GetApiTblDeserializePathResponse, unknown, ThrowOnError>({
...
export const postApiTblDeserialize = <ThrowOnError extends boolean = false>(options: Options<PostApiTblDeserializeData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<PostApiTblDeserializeResponse, unknown, ThrowOnError>({
        ...formDataBodySerializer,
...
export const getApiTblById = <ThrowOnError extends boolean = false>(options: Options<GetApiTblByIdData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<GetApiTblByIdResponse, unknown, ThrowOnError>({
        url: '/api/tbl/{id}',
        ...options
    });
};
...
export const getApiStats = <ThrowOnError extends boolean = false>(options?: Options<GetApiStatsData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).get<GetApiStatsResponse, unknown, ThrowOnError>({
        url: '/api/stats',
        ...options
    });
};
...
export const getApiStatsById = <ThrowOnError extends boolean = false>(options: Options<GetApiStatsByIdData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<GetApiStatsByIdResponse, unknown, ThrowOnError>({
        url: '/api/stats/{id}',
        ...options
    });
};
...
export const getApiUnitStats = <ThrowOnError extends boolean = false>(options?: Options<GetApiUnitStatsData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).get<GetApiUnitStatsResponse, unknown, ThrowOnError>({
        url: '/api/unit-stats',
        ...options
    });
};
...
export const getApiUnitStatsByUnitId = <ThrowOnError extends boolean = false>(options: Options<GetApiUnitStatsByUnitIdData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<GetApiUnitStatsByUnitIdResponse, unknown, ThrowOnError>({
...
export const getApiUnitStatsAmmoSlotByUnitId = <ThrowOnError extends boolean = false>(options: Options<GetApiUnitStatsAmmoSlotByUnitIdData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<GetApiUnitStatsAmmoSlotByUnitIdResponse, unknown, ThrowOnError>({
...
export const postApiUnitStatsAmmoSlot = <ThrowOnError extends boolean = false>(options: Options<PostApiUnitStatsAmmoSlotData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<PostApiUnitStatsAmmoSlotResponse, unknown, ThrowOnError>({
...
export const getApiSeries = <ThrowOnError extends boolean = false>(options?: Options<GetApiSeriesData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).get<GetApiSeriesResponse, unknown, ThrowOnError>({
        url: '/api/series',
        ...options
    });
};
...
export const getApiSeriesUnits = <ThrowOnError extends boolean = false>(options?: Options<GetApiSeriesUnitsData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).get<GetApiSeriesUnitsResponse, unknown, ThrowOnError>({
...
export const getApiProjectiles = <ThrowOnError extends boolean = false>(options?: Options<GetApiProjectilesData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).get<GetApiProjectilesResponse, unknown, ThrowOnError>({
        url: '/api/projectiles',
        ...options
    });
};
...
export const getApiProjectilesByHash = <ThrowOnError extends boolean = false>(options: Options<GetApiProjectilesByHashData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<GetApiProjectilesByHashResponse, unknown, ThrowOnError>({
        url: '/api/projectiles/{hash}',
        ...options
    });
};
...
export const getApiUnitProjectiles = <ThrowOnError extends boolean = false>(options?: Options<GetApiUnitProjectilesData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).get<GetApiUnitProjectilesResponse, unknown, ThrowOnError>({
...
export const getApiUnitProjectilesByUnitId = <ThrowOnError extends boolean = false>(options: Options<GetApiUnitProjectilesByUnitIdData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<GetApiUnitProjectilesByUnitIdResponse, unknown, ThrowOnError>({
...
export const getApiHitboxes = <ThrowOnError extends boolean = false>(options?: Options<GetApiHitboxesData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).get<GetApiHitboxesResponse, unknown, ThrowOnError>({
        url: '/api/hitboxes',
        ...options
    });
};
...
export const getApiHitboxesByHash = <ThrowOnError extends boolean = false>(options: Options<GetApiHitboxesByHashData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<GetApiHitboxesByHashResponse, unknown, ThrowOnError>({
        url: '/api/hitboxes/{hash}',
        ...options
    });
};
...
export const getApiHitboxGroups = <ThrowOnError extends boolean = false>(options?: Options<GetApiHitboxGroupsData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).get<GetApiHitboxGroupsResponse, unknown, ThrowOnError>({
...
export const getApiHitboxGroupsHashByHash = <ThrowOnError extends boolean = false>(options: Options<GetApiHitboxGroupsHashByHashData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<GetApiHitboxGroupsHashByHashResponse, unknown, ThrowOnError>({
...
export const getApiHitboxGroupsUnitIdByUnitId = <ThrowOnError extends boolean = false>(options: Options<GetApiHitboxGroupsUnitIdByUnitIdData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<GetApiHitboxGroupsUnitIdByUnitIdResponse, unknown, ThrowOnError>({
...
export const getApiAssets = <ThrowOnError extends boolean = false>(options?: Options<GetApiAssetsData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).get<GetApiAssetsResponse, unknown, ThrowOnError>({
        url: '/api/assets',
        ...options
    });
};
...
export const getApiAssetsByHash = <ThrowOnError extends boolean = false>(options: Options<GetApiAssetsByHashData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<GetApiAssetsByHashResponse, unknown, ThrowOnError>({
        url: '/api/assets/{hash}',
        ...options
    });
};
