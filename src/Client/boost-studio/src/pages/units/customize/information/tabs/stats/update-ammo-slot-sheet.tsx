...
import {updateAmmoSlotSchema, UpdateAmmoSlotSchema} from "@/pages/units/customize/libs/validations";
...
import {AmmoSlotContext, AmmoSlotContextType} from './ammo-slots';

interface UpdateAmmoSlotSheetProps extends React.ComponentPropsWithRef<typeof Sheet> {
  unitId: number
  index: number
  ammoOptions: number[]
}

const UpdateAmmoSlotSheet = ({children, unitId, index, ammoOptions, ...props}: UpdateAmmoSlotSheetProps) => {
