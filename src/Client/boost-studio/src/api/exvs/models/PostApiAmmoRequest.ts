 ...
 * 
 * @export
 * @interface PostApiAmmoRequest
 */
export interface PostApiAmmoRequest {
    /**
     * 
     * @type {number}
     * @memberof PostApiAmmoRequest
     */
    ammoType?: number;
    /**
     * 
...
/**
 * Check if a given object implements the PostApiAmmoRequest interface.
 */
export function instanceOfPostApiAmmoRequest(value: object): value is PostApiAmmoRequest {
    return true;
}

export function PostApiAmmoRequestFromJSON(json: any): PostApiAmmoRequest {
    return PostApiAmmoRequestFromJSONTyped(json, false);
}

export function PostApiAmmoRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): PostApiAmmoRequest {
    if (json == null) {
        return json;
    }
    return {
...
export function PostApiAmmoRequestToJSON(value?: PostApiAmmoRequest | null): any {
    if (value == null) {
        return value;
    }
    return {
