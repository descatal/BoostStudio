 ...
 * 
 * @export
 * @interface GetApiStats200ResponseItemsInner
 */
export interface GetApiStats200ResponseItemsInner {
    /**
     * 
     * @type {string}
     * @memberof GetApiStats200ResponseItemsInner
     */
    id?: string;
    /**
     * 
...
/**
 * Check if a given object implements the GetApiStats200ResponseItemsInner interface.
 */
export function instanceOfGetApiStats200ResponseItemsInner(value: object): value is GetApiStats200ResponseItemsInner {
    return true;
}

export function GetApiStats200ResponseItemsInnerFromJSON(json: any): GetApiStats200ResponseItemsInner {
    return GetApiStats200ResponseItemsInnerFromJSONTyped(json, false);
}

export function GetApiStats200ResponseItemsInnerFromJSONTyped(json: any, ignoreDiscriminator: boolean): GetApiStats200ResponseItemsInner {
    if (json == null) {
        return json;
    }
    return {
...
export function GetApiStats200ResponseItemsInnerToJSON(value?: GetApiStats200ResponseItemsInner | null): any {
    if (value == null) {
        return value;
    }
    return {
