 ...
 * 
 * @export
 * @interface PostApiProjectilesByHashRequest
 */
export interface PostApiProjectilesByHashRequest {
    /**
     * 
     * @type {number}
     * @memberof PostApiProjectilesByHashRequest
     */
    hash: number;
    /**
     * 
...
/**
 * Check if a given object implements the PostApiProjectilesByHashRequest interface.
 */
export function instanceOfPostApiProjectilesByHashRequest(value: object): value is PostApiProjectilesByHashRequest {
    if (!('hash' in value) || value['hash'] === undefined) return false;
    return true;
}

export function PostApiProjectilesByHashRequestFromJSON(json: any): PostApiProjectilesByHashRequest {
    return PostApiProjectilesByHashRequestFromJSONTyped(json, false);
}

export function PostApiProjectilesByHashRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): PostApiProjectilesByHashRequest {
    if (json == null) {
        return json;
    }
    return {
...
export function PostApiProjectilesByHashRequestToJSON(value?: PostApiProjectilesByHashRequest | null): any {
    if (value == null) {
        return value;
    }
    return {
