 ...
 * 
 * @export
 * @interface PostApiProjectilesRequest
 */
export interface PostApiProjectilesRequest {
    /**
     * 
     * @type {number}
     * @memberof PostApiProjectilesRequest
     */
...
/**
 * Check if a given object implements the PostApiProjectilesRequest interface.
 */
export function instanceOfPostApiProjectilesRequest(value: object): value is PostApiProjectilesRequest {
    return true;
}

export function PostApiProjectilesRequestFromJSON(json: any): PostApiProjectilesRequest {
    return PostApiProjectilesRequestFromJSONTyped(json, false);
}

export function PostApiProjectilesRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): PostApiProjectilesRequest {
    if (json == null) {
        return json;
    }
    return {
...
export function PostApiProjectilesRequestToJSON(value?: PostApiProjectilesRequest | null): any {
    if (value == null) {
        return value;
    }
    return {
