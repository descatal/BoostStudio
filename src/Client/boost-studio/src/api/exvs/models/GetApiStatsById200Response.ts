 ...
 * 
 * @export
 * @interface GetApiStatsById200Response
 */
export interface GetApiStatsById200Response {
    /**
     * 
     * @type {string}
     * @memberof GetApiStatsById200Response
     */
    id?: string;
    /**
     * 
...
/**
 * Check if a given object implements the GetApiStatsById200Response interface.
 */
export function instanceOfGetApiStatsById200Response(value: object): value is GetApiStatsById200Response {
    return true;
}

export function GetApiStatsById200ResponseFromJSON(json: any): GetApiStatsById200Response {
    return GetApiStatsById200ResponseFromJSONTyped(json, false);
}

export function GetApiStatsById200ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): GetApiStatsById200Response {
    if (json == null) {
        return json;
    }
    return {
...
export function GetApiStatsById200ResponseToJSON(value?: GetApiStatsById200Response | null): any {
    if (value == null) {
        return value;
    }
    return {
