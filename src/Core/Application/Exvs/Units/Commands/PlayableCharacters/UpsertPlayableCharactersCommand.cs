...
public record UpsertPlayableCharactersCommand(uint UnitId) : PlayableCharacterDetailsDto, IRequest;

public class UpsertPlayableCharactersCommandHandler(
    IApplicationDbContext applicationDbContext
) : IRequestHandler<UpsertPlayableCharactersCommand>
{
    public async ValueTask<Unit> Handle(UpsertPlayableCharactersCommand command, CancellationToken cancellationToken)
    {
